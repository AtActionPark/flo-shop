...
const ProductPage = ({ productId }) => {
  ...
  const images = product?.localFiles? [...product.localFiles] : []
    ...
    <div className={css.container}>
      ...
      <div className={css.controls}>
        ...
        <button
          ...
          disabled={!available(activePrice.id) || !product.active}
        >
          {available(activePrice.id) && product.active ? "Add To Cart" : "Sold Out"}
        </button>
      </div>
    </div>
  )
